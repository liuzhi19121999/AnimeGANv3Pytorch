...
class ImageDataSet(Dataset):
    ...
    def __getitem__(self, index) -> dict[str, Tensor]:
        ...
        photo = self.load_photo(self.photo_data[photo_index])
        style = self.load_photo(self.style_data[style_index])
        smooth = self.load_photo(self.smooth_data[smooth_index])
        smooth_noise = self.load_photo(self.smooth_noise_data[smooth_noise_index])
